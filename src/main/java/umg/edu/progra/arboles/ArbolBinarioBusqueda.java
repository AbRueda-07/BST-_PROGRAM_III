...
public class ArbolBinarioBusqueda {
    ...
    public int ancestroComunMasBajo(int a, int b) {
        ...
        if (!contiene(a) || !contiene(b)) {
            throw new IllegalArgumentException(
                    "Uno o ambos valores no existen en el arbol");
        }
        ...
        throw new IllegalStateException("No se encontro ancestro comun");
    }//agregado
    ...
    public void construirBSTInvalidoDePrueba() {
        ...
        raiz.derecho.izquierdo = new Nodo(20); // ERROR intencional para realizar prueba
    ...
    public int diametro() {
        ...
        Entero diametro = new Entero();

        calcularDiametro(raiz, diametro);

        return diametro.valor;
    }

    private int calcularDiametro(
            Nodo nodo,
            Entero diametro) {
        ...
        if (diametroActual > diametro.valor) {
            diametro.valor = diametroActual;
        }
